#include "TRPRootListController.h"

@implementation TRPRootListController
...
- (instancetype)init {
    ...
    if (self) {
        ...
        self.titleLabel.text = @"Tempus Romānum";
        [self.navigationItem.titleView addSubview:self.titleLabel];
    
        self.iconView = [[UIImageView alloc] initWithFrame:CGRectMake(0,0,10,10)];
        self.iconView.contentMode = UIViewContentModeScaleAspectFit;
        self.iconView.image = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/tempusromanumprefs.bundle/prefsicon@2x.png"];
...
@interface TRPTwitterCell () {
    NSString *_user;
}
@end

@implementation TRPTwitterCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier specifier:(PSSpecifier *)specifier
{
    ...
    if (self) {
        ...
        /*self.avatarImage = [UIImage imageNamed:[NSString stringWithFormat:@"/Library/PreferenceBundles/tempusromanumprefs.bundle/%@.png", _user]];
         */
